...
class DeadlineWeekly extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'deadline:weekly';
     ...
     * @var string
     */
    protected $description = 'Checks if today is 30 days or less before the deadline and will email everyone';
