...
class MaterialController extends Controller
{
    ...
    public function update(Request $request, Material $material)
    {
        ...
        return redirect()->route('hap.review.material.show', $material->id)->with('success', 'Form updated successfully.');
    ...
    public function removeFileInEdit(Material $material, Request $request){
        ...
        return redirect()->route('hap.review.material.edit', $material)->with('success', 'Document deleted successfully.');
    }
}
