...
class PartnershipController extends Controller
{
    ...
    public function update(Request $request, Partnership $partnership)
    {
        ...
        return redirect()->route('hap.review.partnership.show', $partnership->id)->with('success', 'Form updated successfully.');
    ...
    public function removeFileInEdit(Partnership $partnership, Request $request){
        ...
        return redirect()->route('hap.review.partnership.edit', $partnership)->with('success', 'Document deleted successfully.');
    }
}
