...
class MySubmissionController extends Controller
{
    public function index(){
        ...
        return view('submissions.myaccomplishments.index', compact('roles', 'colleges', 'departments', 'my_accomplishments', 'college_names', 'department_names', 'year', 'quarter', 'report_categories'));
    }
