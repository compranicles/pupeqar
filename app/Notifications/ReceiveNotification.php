    ...
    public function toMail($notifiable)
    {
        ...
        if($this->notificationData['accomplishment_type'] == 'individual')
            return (new MailMessage)
                        ->subject('PUP eQAR | Accomplishment Received Notification')
                        ->greeting('Hello '.$this->notificationData['receiver'].'!')
                        ->line('Your accomplishment on '.$this->notificationData['category_name'].' has been received by '.$this->notificationData['sender'].'.')
                        ->action('View Accomplishment', $this->notificationData['url']);
        elseif($this->notificationData['accomplishment_type'] == 'department')
            return (new MailMessage)
                ->subject('PUP eQAR | Accomplishment Received Notification')
                ->greeting('Hello '.$this->notificationData['receiver'].'!')
                ->line('The accomplishment of '.$this->notificationData['department_name'].' on '.$this->notificationData['category_name'].' has been received by '.$this->notificationData['sender'].'.')
                ->action('View Accomplishment', $this->notificationData['url']);
        ...
        elseif($this->notificationData['accomplishment_type'] == 'college')
            return (new MailMessage)
                ->subject('PUP eQAR | Accomplishment Received Notification')
                ->greeting('Hello '.$this->notificationData['receiver'].'!')
                ->line('The accomplishment of '.$this->notificationData['college_name'].' on '.$this->notificationData['category_name'].' has been received by '.$this->notificationData['sender'].'.')
                ->action('View Accomplishment', $this->notificationData['url']);
    }
    ...
    public function toArray($notifiable)
    {
        ...
        elseif($this->notificationData['accomplishment_type'] == 'college')
            return [
                ...
                'accomplishment_type' => $this->notificationData['accomplishment_type'],
                'date' => $this->notificationData['date'],
                'college_name' => $this->notificationData['college_name']
            ];
    }
}
