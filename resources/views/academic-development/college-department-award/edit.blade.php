<x-app-layout>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="font-weight-bold mr-2">Edit Award & Recognition Received</h3>
                <div class="mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="edit_form" action="{{ route('college-department-award.update', $college_department_award->id) }}" method="post">
                            @csrf
                            @method('put')
                            @include('form', ['formFields' => $awardFields, 'value' => $values, 'colleges' => $colleges, 'colaccomp' => 1])
                            <div class="col-md-12">
                                <div class="mb-0">
    ...
    @push('scripts')
        ...
        <script>
            $('#submit_save').on('click', function () {
                $('#edit_form').attr('action', "{{ route('college-department-award.update', $college_department_award->id) }}"+"?o=submit");
                $('#edit_form').submit();
            });
        </script>
    @endpush
