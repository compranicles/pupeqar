<x-app-layout>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="font-weight-bold mr-2">Add Student Award</h3>
                <div class="mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="create_form" action="{{ route('student-award.store') }}" method="post" class="needs-validation" novalidate>
                            <div class="mt-2 mb-3">
    ...
    <script>
        ...
        $.get("{{ url('document-upload/description/18') }}", function (data){
            if (data != '') {
    ...
    <script>
        $('#submit_save').on('click', function () {
            $('#create_form').attr('action', "{{ route('student-award.store') }}"+"?o=submit");
            $('#create_form').submit();
        });
    </script>
    @endpush
