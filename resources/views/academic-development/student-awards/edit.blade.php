    ...
    <div class="container">
        <div class="row">
            ...
            @endif
                <div class="card">
                    <div class="card-body">
                        <form id="edit_form" action="{{ route('student-award.update', $student_award->id) }}" method="post">
                            @csrf
                            @method('put')
    ...
    @push('scripts')
        ...
        <script>
            $('#submit_save').on('click', function () {
                $('#edit_form').attr('action', "{{ route('student-award.update', $student_award->id) }}"+"?o=submit");
                $('#edit_form').submit();
            });
        </script>
    @endpush
