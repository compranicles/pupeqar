                            ...
                            <table class="table" id="student_award_table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="tr-hover" role="button">
                                        ...
                                        <td class="{{ ($row->report_quarter == $currentQuarterYear->current_quarter && $row->report_year == $currentQuarterYear->current_year) ? 'to-submit' : '' }}" onclick="window.location.href = '{{ route('student-award.show', $row->id) }}' " >
                                            {{ $row->report_quarter }}
                                        </td>
