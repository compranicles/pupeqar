                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="button-group">
                                                ...
                                                @elseif ($submissionStatus[18][$row->id] == 2)
                                                    <a href="{{ route('student-award.edit', $row->id) }}#upload-document" class="btn btn-sm btn-warning d-inline-flex align-items-center d-inline-flex align-items-center"><i class="bi bi-exclamation-circle-fill text-danger mr-1"></i> No Document</a>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
