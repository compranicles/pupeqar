    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="create_form" action="{{ route('student-training.store') }}" method="post" class="needs-validation" novalidate>
                            <div class="mt-2 mb-3">
...
@push('scripts')
    ...
    <script>
        $('#submit_save').on('click', function () {
            $('#create_form').attr('action', "{{ route('student-training.store') }}"+"?o=submit");
            $('#create_form').submit();
        });
    </script>
@endpush
