                                    ...
                                    <tr class="tr-hover" role="button">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="button-group">
                                                ...
                                                <button type="button"  value="{{ $syllabus->id }}" class="btn btn-sm btn-dange d-inline-flex align-items-centerr" data-bs-toggle="modal" data-bs-target="#deleteModal" data-bs-syllabus="{{ $syllabus->course_title }}">Delete</button>
