...
@section('title', 'Syllabus |')
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-9">
                <div>
                  <h3 class="font-weight-bold mr-2">Course Syllabus</h3>
                </div>
                <div class="d-flex align-items-center mb-2">
                    <a class="mr-auto back_link ml-2" href="{{ route('syllabus.index') }}"><i class="bi bi-chevron-double-left"></i>Back to all Course Syllabi</a>
                    <a href="{{ route('syllabus.edit', $syllabu->id) }}" class="action_buttons_show mr-3 ml-3"><i class="bi bi-pencil-square"></i> Edit</a>
