                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input class="{{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title"
                                                    :value="old('title', $announcement->title)" required autofocus autocomplete="name" />
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input class="{{ $errors->has('subject') ? 'is-invalid' : '' }}" type="text" name="subject"
                                                    :value="old('subject', $announcement->subject)" required autofocus autocomplete="name" />
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="message" id="message" :value="old('message')" cols="30" rows="10" class="{{ $errors->has('message') ? 'is-invalid' : '' }} form-control" required autofocus autocomplete="message">{{ $announcement->message }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="{{ $errors->has('status') ? 'is-invalid' : '' }} form-control" :value="old('status', $announcement->status)" required autofocus>
