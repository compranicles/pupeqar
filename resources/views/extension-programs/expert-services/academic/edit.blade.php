<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 font-weight-bold">
            {{ __('Edit Expert Service in Academic Journals/Books/Publication/Newsletter/Creative Works') }}
        </h2>
    </x-slot>
        ...
        <div class="row">
            ...
            <p>
              <a class="back_link" href="{{ route('faculty.expert-service-in-academic.index') }}"><i class="bi bi-chevron-double-left"></i>Back to all Expert Services in Academic Journals/Books/Publication/Newsletter/Creative Works</a>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('faculty.expert-service-in-academic.update', $expert_service_in_academic->id) }}" method="post">
                            @csrf
                            @method('put')
