<x-app-layout>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="font-weight-bold mr-2">Edit Expert Service Rendered in Rendered in Academic Works</h3>
                <div class="mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="edit_form" action="{{ route('expert-service-in-academic.update', $value['id']) }}" method="post">
                            @csrf
                            @method('put')
    ...
    @push('scripts')
        ...
        <script>
            $('#submit_save').on('click', function () {
                $('#edit_form').attr('action', "{{ route('expert-service-in-academic.update', $value['id']) }}"+"?o=submit");
                $('#edit_form').submit();
            });
        </script>
        {{-- <script>
