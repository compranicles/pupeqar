<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 font-weight-bold">
            {{ __('View Expert Service in Academic Journals/Books/Publication/Newsletter/Creative Works') }}
        </h2>
    </x-slot>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            <p>
              <a class="back_link" href="{{ route('faculty.expert-service-as-consultant.index') }}"><i class="bi bi-chevron-double-left"></i>Back to all Expert Services in Academic Journals/Books/Publication/Newsletter/Creative Works</a>
            </p>
                <div class="card">
                    <div class="card-body">

                            @include('extension-programs.form', ['formFields' => $expertServiceAcademicFields, 'value' => $expert_service_in_academic])
