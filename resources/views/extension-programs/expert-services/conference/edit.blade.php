<x-app-layout>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="font-weight-bold mr-2">Edit Expert Service Rendered in Conference, Workshops, and/or Training Course</h3>
                <div class="mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="edit_form" action="{{ route('expert-service-in-conference.update', $expert_service_in_conference->id) }}" method="post">
                            @csrf
                            @method('put')
    ...
    @push('scripts')
        ...
        <script>
            $('#submit_save').on('click', function () {
                $('#edit_form').attr('action', "{{ route('syllabus.update', $value['id']) }}"+"?o=submit");
                $('#edit_form').submit();
            });
        </script>
    @endpush
