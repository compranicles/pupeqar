    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="edit_form" action="{{ route('expert-service-as-consultant.update', $expert_service_as_consultant->id) }}" method="post">
                            @csrf
                            @method('put')
    ...
    @push('scripts')
        ...
        <script>
            $('#submit_save').on('click', function () {
                $('#edit_form').attr('action', "{{ route('expert-service-as-consultant.update', $expert_service_as_consultant->id) }}"+"?o=submit");
                $('#edit_form').submit();
            });
        </script>
    @endpush
