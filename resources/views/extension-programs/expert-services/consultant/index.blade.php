                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="button-group">
                                                ...
                                                @elseif ($submissionStatus[9][$expertServiceConsultant->id] == 1)
                                                    <a href="{{ url('submissions/check/9/'.$expertServiceConsultant->id) }}" class="btn btn-sm btn-success d-inline-flex align-items-center">Submitted {{ $submitRole[$expertServiceConsultant->id] == 'f' ? 'as Faculty' : 'as Admin' }}</a>
