    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="edit_form" action="{{ route('extension-service.update', $value['id'] ) }}" method="post" class="needs-validation" novalidate>
                            @csrf
                            @method('put')
    ...
    @push('scripts')
        ...
        <script>
            $('#submit_save').on('click', function () {
                $('#edit_form').attr('action', "{{ route('extension-service.update', $value['id'] ) }}"+"?o=submit");
                $('#edit_form').submit();
            });
        </script>
    @endpush
