    ...
    <div class="col-md-12 mt-3 mb-3">
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input @if ($value!='') value="{{ $value['quality_poor'] }}" @endif type="number" class="form-control form-validation" id="qpoor" name="quality_poor">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label for="qfair">Fair</label>
                <input type="number" @if ($value!='') value="{{ $value['quality_fair'] }}" @endif class="form-control form-validation" id="qfair" name="quality_fair">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label for="qsatisfactory">Satisfactory</label>
                <input type="number" @if ($value!='') value="{{ $value['quality_satisfactory'] }}" @endif class="form-control form-validation" id="qsatisfactory" name="quality_satisfactory">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label for="qverysatisfactory">Very Satisfactory</label>
                <input type="number" @if ($value!='') value="{{ $value['quality_very_satisfactory'] }}" @endif class="form-control form-validation" id="qverysatisfactory" name="quality_very_satisfactory">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label for="qoutstanding">Outstanding</label>
                <input type="number" @if ($value!='') value="{{ $value['quality_outstanding'] }}" @endif class="form-control form-validation" id="qoutstanding" name="quality_outstanding">
            </div>
        </div>
        </div>
    </div>
