<x-app-layout>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="font-weight-bold mr-2">Add Intra-Country Mobility</h3>
                <div class="mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="create_form" action="{{ route('intra-mobility.store') }}" method="post" class="needs-validation" novalidate>
                            <div class="mt-2 mb-3">
    ...
    @push('scripts')
        ...
        <script>
            $('#submit_save').on('click', function () {
                $('#create_form').attr('action', "{{ route('intra-mobility.store') }}"+"?o=submit");
                $('#create_form').submit();
            });
        </script>
    @endpush
