<x-app-layout>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="font-weight-bold mr-2">Edit Inter-Country Mobility</h3>
                <div class="mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="edit_form" action="{{ route('mobility.update', $mobility->id) }}" method="post" class="needs-validation" novalidate>
                            @csrf
                            @method('put')
       ...
       <script>
        ...
        <script>
            $('#submit_save').on('click', function () {
                $('#edit_form').attr('action', "{{ route('mobility.update', $mobility->id) }}"+"?o=submit");
                $('#edit_form').submit();
            });
        </script>
    @endpush
