                                            ...
                                            <div class="btn-group" role="group" aria-label="button-group">
                                                ...
                                                @if($row->classification_of_person == '298')
                                                    ...
                                                    @elseif ($submissionStatus[35][$row->id] == 1)
                                                        <a href="{{ url('submissions/check/35/'.$row->id) }}" class="btn btn-sm btn-success d-inline-flex align-items-center">Submitted</a>
                                                ...
                                                @else
                                                    ...
                                                    @elseif ($submissionStatus[14][$row->id] == 1)
                                                        <a href="{{ url('submissions/check/14/'.$row->id) }}" class="btn btn-sm btn-success d-inline-flex align-items-center">Submitted</a>
