                                    ...
                                    <tr class="tr-hover" role="button">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="button-group">
                                                <a href="{{ route('other-accomplishment.show', $row->id) }}" class="btn btn-sm btn-primary d-inline-flex align-items-center">View</a>
                                                ...
                                                @elseif ($submissionStatus[38][$row->id] == 1)
                                                    <a href="{{ url('submissions/check/38/'.$row->id) }}" class="btn btn-sm btn-success d-inline-flex align-items-center">Submitted {{ $submitRole[$row->id] == 'f' ? 'as Faculty' : 'as Admin' }}</a>
