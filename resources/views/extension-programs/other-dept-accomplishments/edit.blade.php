<x-app-layout>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="edit_form" action="{{ route('other-dept-accomplishment.update', $otherDeptAccomplishment->id) }}" method="post" class="needs-validation" novalidate>
                            @csrf
                            @method('put')
                                                ...
                                                <div class="col-md-12 mb-3  documents-display" id="doc-{{ $document['id'] }}">
                                                    <div class="card bg-light border border-maroon rounded-lg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <button class="btn btn-danger remove-doc" data-id="doc-{{ $document['id'] }}" data-link="{{ route('other-dept-accomplishment.removedoc', $document['filename']) }}" data-toggle="modal" data-target="#deleteModal">Delete</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    @push('scripts')
       ...
       <script>
            ...
            $.get("{{ url('document-upload/description/38') }}", function (data){
                if (data != '') {
        ...
        <script>
            $('#submit_save').on('click', function () {
                $('#edit_form').attr('action', "{{ route('other-dept-accomplishment.update', $otherDeptAccomplishment->id) }}"+"?o=submit");
                $('#edit_form').submit();
            });
        </script>
    @endpush
