                                    ...
                                    <tr class="tr-hover" role="button">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="button-group">
                                                <a href="{{ route('other-dept-accomplishment.show', $row->id) }}" class="btn btn-sm btn-warning">View</a>
                                                <a href="{{ route('other-dept-accomplishment.edit', $row->id) }}" class="btn btn-sm btn-warning">Edit</a>
