                            ...
                            <table class="table" id="other_accomplishment_table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="tr-hover" role="button">
                                        ...
                                        <td onclick="window.location.href = '{{ route('other-dept-accomplishment.show', $row->id) }}' ">{{ $row->college_name }}</td>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="button-group">
                                                <a href="{{ route('other-dept-accomplishment.show', $row->id) }}" class="btn btn-sm btn-warning d-inline-flex align-items-center">View</a>
                                                ...
                                                @if ($submissionStatus[39][$row->id] == 0)
                                                    <a href="{{ url('submissions/check/39/'.$row->id) }}" class="btn btn-sm btn-primary d-inline-flex align-items-center">Submit</a>
                                                @elseif ($submissionStatus[39][$row->id] == 1)
                                                    <a href="{{ url('submissions/check/39/'.$row->id) }}" class="btn btn-sm btn-success d-inline-flex align-items-center">Submitted</a>
