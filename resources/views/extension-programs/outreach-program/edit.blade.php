    ...
    <div class="container">
        <div class="row">
            ...
            @endif
                <div class="card">
                    <div class="card-body">
                        <form id="edit_form" action="{{ route('outreach-program.update', $outreach_program->id) }}" method="post">
                            @csrf
                            @method('put')
    ...
    @push('scripts')
        ...
        <script>
            $('#submit_save').on('click', function () {
                $('#edit_form').attr('action', "{{ route('outreach-program.update', $outreach_program->id) }}"+"?o=submit");
                $('#edit_form').submit();
            });
        </script>
    @endpush
