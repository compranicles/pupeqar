        ...
        <div class="row">
            <div class="col-md-12">
                <div class="d-flex mr-2">
                    ...
                    <p>
                        <button type="button" value="{{ $partnership->id }}" class="action-delete action_buttons_show" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class="bi bi-trash"></i> Delete</button>
                    </p>
                </div>
