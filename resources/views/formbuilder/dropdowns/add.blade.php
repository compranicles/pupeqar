    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.dropdowns.store') }}" class="needs-validation" method="POST" novalidate>
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <table class="table table-borderless" id="dynamic_form">
                            <tr>
                                <td>Label</td>
                                <td>Value</td>
                                <td></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="form-control" type="text" id="addvalue" value="" name="value[]" readonly required>
                                    <div class="invalid-feedback">
                                        This is required. 
                                    </div>
                                </td>
