    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="#" data-action={{ route('admin.forms.fields.update', ['form' => $form_id, 'field' => ':id']) }} id="field_form_edit" class="needs-validation" method="POST">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="label_edit" name="label" required>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="field_name_edit" name="field_name" readonly required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="size" id="size_edit" class="form-control custom-select" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="field_type" id="field_type_edit" class="form-control custom-select" required>
                        ...
                        <div class="col-md-12" id="dropdown_field_edit">
                            {{-- Dropdown --}}
                            <div class="form-group">
                                <x-jet-label value="{{ __('Dropdown') }}" />

                                <select name="dropdown" id="dropdown_edit" class="form-control custom-select">
                                    <option value="" selected disabled>Choose...</option>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="required" name="required" id="required_edit">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="editField" class="btn btn-primary mb-2 mr-2">Save</button>
                </form>
            </div>
        </div>
    </div>
