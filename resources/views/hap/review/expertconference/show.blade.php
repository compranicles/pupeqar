                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <a href="{{ route('hap.review.expertconference.edit', $expertconference->id) }}"  class="btn btn-primary mb-2 mr-2"><i class="far fa-edit"></i> Edit</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('hap.review.expertconference.destroy', $expertconference->id) }}" method="POST">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @csrf
                    <input type="hidden" name="formId" value="{{ $expertconference->id }}">
                    <input type="hidden" name="formname" value="{{ 'expertconference' }}">
