                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <a href="{{ route('hap.review.expertjournal.edit', $expertjournal->id) }}"  class="btn btn-primary mb-2 mr-2"><i class="far fa-edit"></i> Edit</a>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">External Services Rendered in Academic Journals/Books Publication/Newsletter/Creative Work: </span>
                                                <span class="d-block ml-4">{{ $servicejournal->name }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Nature of  Services Rendered: </span>
                                                <span class="d-block ml-4">{{ $servicenature->name}}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Publication/Audio Visual Production: </span>
                                                <span class="d-block ml-4">{{ $expertjournal->production }}</span>
                                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Indexing: </span>
                                                <span class="d-block ml-4">{{ $indexplatform->name }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Copyright No. (ISSN No./E-ISSN/ISBN): </span>
                                                <span class="d-block ml-4">{{ $expertjournal->isbn }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <span class="d-block ml-4">{{ $expertjournal->document_description }}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('hap.review.expertjournal.destroy', $expertjournal->id) }}" method="POST">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @csrf
                    <input type="hidden" name="formId" value="{{ $expertjournal->id }}">
                    <input type="hidden" name="formname" value="{{ 'expertjournal' }}">
