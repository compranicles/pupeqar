                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <a href="{{ route('hap.review.facultyintercountry.edit', $facultyintercountry->id) }}"  class="btn btn-primary mb-2 mr-2"><i class="far fa-edit"></i> Edit</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('hap.review.facultyintercountry.destroy', $facultyintercountry->id) }}" method="POST">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @csrf
                    <input type="hidden" name="formId" value="{{ $facultyintercountry->id }}">
                    <input type="hidden" name="formname" value="{{ 'facultyintercountry' }}">
