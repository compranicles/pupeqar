                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-md-6">
                                ...
                                <a href="{{ route('hap.review.invention.edit', $invention->id) }}"  class="btn btn-primary mb-2 mr-2"><i class="far fa-edit"></i> Edit</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('hap.review.invention.destroy', $invention->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @csrf
                    <input type="hidden" name="formId" value="{{ $invention->id }}">
                    <input type="hidden" name="formname" value="{{ 'invention' }}">
