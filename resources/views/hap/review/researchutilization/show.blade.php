                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-md-6">
                                ...
                                <a href="{{ route('hap.review.researchutilization.edit', $research->id) }}"  class="btn btn-primary mb-2 mr-2"><i class="far fa-edit"></i> Edit</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('hap.review.researchutilization.destroy', $research->id) }}" method="POST">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="formname" value="{{ 'researchutilization' }}">
