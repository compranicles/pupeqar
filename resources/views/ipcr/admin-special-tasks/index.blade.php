                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="button-group">
                                                ...
                                                @elseif ($submissionStatus[29][$row->id] == 1)
                                                    <a href="{{ url('submissions/check/29/'.$row->id) }}" class="btn btn-sm btn-success d-inline-flex align-items-center">Submitted {{ $submitRole[$row->id] == 'f' ? 'as Faculty' : 'as Admin' }}</a>
