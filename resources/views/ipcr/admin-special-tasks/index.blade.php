                                    ...
                                    <tr class="tr-hover" role="button">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="button-group">
                                                <a href="{{ route('admin-special-tasks.show', $row->id) }}" class="btn btn-sm btn-primary d-inline-flex align-items-center">Edit</a>
                                                ...
                                                @if ($submissionStatus[29][$row->id] == 0)
                                                    <a href="{{ url('submissions/check/29/'.$row->id) }}" class="btn btn-sm btn-primary d-inline-flex align-items-center">Submit</a>
                                                @elseif ($submissionStatus[29][$row->id] == 1)
                                                    <a href="{{ url('submissions/check/29/'.$row->id) }}" class="btn btn-sm btn-success d-inline-flex align-items-center">Submitted</a>
