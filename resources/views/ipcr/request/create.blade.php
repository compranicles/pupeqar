<x-app-layout>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="font-weight-bold mr-2">Add Request & Queries Acted Upon</h3>
                <div class="mb-3">
                    <a class="back_link" href="{{ route('request.index') }}"><i class="bi bi-chevron-double-left"></i>Back to all Request & Queries Acted Upon</a>
                </div>
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('request.store' ) }}" enctype="multipart/form-data" method="post" class="needs-validation" novalidate>
                            <div class="mt-2 mb-3">
