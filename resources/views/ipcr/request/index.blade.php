                                    ...
                                    <tr class="tr-hover" role="button">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="button-group">
                                                ...
                                                <button type="button" value="{{ $row->id }}" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-bs-request="{{ $row->description_of_request }}">Delete</button>
