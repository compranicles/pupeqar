...
@section('title', 'Academic Module Fields Manager |')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                <h4>{{ $academic_module_form->label }} Fields</h4>
                                <hr>
                            </div>
                            {{-- ADD Fields --}}
                            <div class="col-md-12">
    ...
    @include('maintenances.academic-module.add', [
        'form_id' => $academic_module_form->id,
    ...
    @push('scripts')
        ...
        <script>
            $(function() {
				var url1 = "{{ url('academic-module-fields/arrange') }}";
				...
				var urlAct =  "{{ url('academic-module-fields/activate/:id') }}";
				var urlInaAct =  "{{ url('academic-module-fields/inactivate/:id') }}";
