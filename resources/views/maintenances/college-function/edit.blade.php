<x-app-layout>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="font-weight-bold mr-2">Edit College Function</h3>
                <p>
                    <a class="back_link" href="{{ route('college-function-manager.index') }}"><i class="bi bi-chevron-double-left"></i>Back to University Functions Manager</a>
                </p>
