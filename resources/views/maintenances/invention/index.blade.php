<x-app-layout>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h2 class="font-weight-bold mb-2">Invention Forms</h2>
            </div>
            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table text-center">
                                        ...
                                        <tbody>
                                            @foreach ($inventionforms as $form)
                                            <tr>
                                                <td>{{ $form->label }}</td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="{{ route('invention-forms.edit', $form->id) }}" class="btn btn-primary btn-sm mr-2">Rename</a>
                                                    <a href="{{ route('invention-forms.show', $form->id) }}" class="btn btn-warning edit-row btn-sm">Manage Fields</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
