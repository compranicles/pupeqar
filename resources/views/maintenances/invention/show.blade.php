<x-app-layout>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody id="field_sortable">
                                            @foreach ($invention_fields as $field)
                                            <tr id="{{ $field->id }}">
                                                <td>{{ $field->label }}</td>
    ...
    @include('maintenances.invention.add', [
        'form_id' => $invention_form->id,
    ...
    @push('scripts')
        ...
        <script>
             $(function() {
				var url1 = "{{ url('invention-fields/arrange') }}";
				...
				var urlAct =  "{{ url('invention-fields/activate/:id') }}";
				var urlInaAct =  "{{ url('invention-fields/inactivate/:id') }}";
