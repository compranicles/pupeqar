                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                <h4>{{ $ipcr_form->label }} Field > {{ $ipcr_field->label }}</h4>
                                <hr>
                            </div>
                            {{-- ADD Fields --}}
                            <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="label" name="label" value="{{ $ipcr_field->label }}" required>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="field_name" name="field_name" value="{{ $ipcr_field->name }}" disabled required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="size" id="size" class="form-control custom-select" required>
                                                    <option value="col-md-12" {{ ($ipcr_field->size === 'col-md-12')? 'selected': '' }}>col-md-12</option>
                                                    <option value="col-md-11" {{ ($ipcr_field->size === 'col-md-11')? 'selected': '' }}>col-md-11</option>
                                                    <option value="col-md-10" {{ ($ipcr_field->size === 'col-md-10')? 'selected': '' }}>col-md-10</option>
                                                    <option value="col-md-9" {{ ($ipcr_field->size === 'col-md-9')? 'selected': '' }}>col-md-9</option>
                                                    <option value="col-md-8" {{ ($ipcr_field->size === 'col-md-8')? 'selected': '' }}>col-md-8</option>
                                                    <option value="col-md-7" {{ ($ipcr_field->size === 'col-md-7')? 'selected': '' }}>col-md-7</option>
                                                    <option value="col-md-6" {{ ($ipcr_field->size === 'col-md-6')? 'selected': '' }}>col-md-6</option>
                                                    <option value="col-md-5" {{ ($ipcr_field->size === 'col-md-5')? 'selected': '' }}>col-md-5</option>
                                                    <option value="col-md-4" {{ ($ipcr_field->size === 'col-md-4')? 'selected': '' }}>col-md-4</option>
                                                    <option value="col-md-3" {{ ($ipcr_field->size === 'col-md-3')? 'selected': '' }}>col-md-3</option>
                                                    <option value="col-md-2" {{ ($ipcr_field->size === 'col-md-2')? 'selected': '' }}>col-md-2</option>
                                                    <option value="col-md-1" {{ ($ipcr_field->size === 'col-md-1')? 'selected': '' }}>col-md-1</option>
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="field_type" id="field_type" class="form-control custom-select" disabled required>
                                                    ...
                                                    <option value="{{ $fieldtype->id }}" {{ ($ipcr_field->field_type_id === $fieldtype->id)? 'selected': '' }} class="{{ $fieldtype->name }}">{{ $fieldtype->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-12" id="dropdown_field">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="dropdown" id="dropdown" class="form-control custom-select" disabled>
                                                    ...
                                                    <option value="{{ $dropdown->id }}" {{ ($ipcr_field->dropdown_id === $dropdown->id)? 'selected': '' }}>{{ $dropdown->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-12" id="placeholderfield">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="placeholder" value="{{ $ipcr_field->placeholder }}" name="placeholder">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" value="1" name="visibility" {{ ($ipcr_field->visibility === 1)? 'checked' : '' }} id="default" required>
                                                <label class="form-check-label" for="default">
                                                    Default
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" value="2" name="visibility" {{ ($ipcr_field->visibility === 2)? 'checked' : '' }} id="readonly" required>
                                                <label class="form-check-label" for="readonly">
                                                    Read-Only
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" value="3" name="visibility" {{ ($ipcr_field->visibility === 3)? 'checked' : '' }} id="disabled" required>
                                                <label class="form-check-label" for="disabled">
                                                    Disabled
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" value="4" name="visibility" {{ ($ipcr_field->visibility === 4)? 'checked' : '' }} id="hidden" required>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                <h4>Suggested {{ $ipcr_field->label }}</h4>
                                <hr>
                            </div>
                            <div class="col-md-12">
