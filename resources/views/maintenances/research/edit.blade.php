<x-app-layout>
    ...
    <div class="container">
        ...
        <div class="col-md-12 d-flex">
                <h2 class="font-weight-bold mb-2">Research Forms > {{ $research_form->label }} Fields > {{ $research_field->label }}</h2>
                <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('research-forms.index') }}">Research Forms</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('research-forms.show', $research_form->id) }}">Fields</a></li>
                    <li class="breadcrumb-item">{{ $research_field->label }}</li>
                </ol>
                </nav>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" id="placeholderfield">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="placeholder" id="placeholder">{{ $research_field->placeholder }}</textarea>
                                                <div class="invalid-feedback">
                                                    This is required.
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-check form-check-inline">
                                                ...
                                                <input class="form-check-input" type="checkbox" value="1" {{ ($research_field->required === 1)? 'checked' : '' }} name="required" id="required">
        ...
        @if ($research_field->label == "Description of Supporting Documents")
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                <h4>Suggested {{ $research_field->label }}</h4>
                                <hr>
                            </div>
                            <div class="col-md-12">
