    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="navbar-nav mr-auto main-nav-item">
                    <x-jet-nav-link :active="request()->routeIs('submissions.*')|| request()->routeIs('to-finalize.*') || request()->routeIs('chairperson.*') || request()->routeIs('dean.*') || request()->routeIs('sector.*') || request()->routeIs('ipqmso.*') || request()->routeIs('reports.*')" href="{{ route('to-finalize.index') }}">
                        {{ __('Submissions') }}
