<table class="table table-sm mt-n2 table-hover text-centered" style="width: 100%" id="notification_nav_table">
    <tbody>
    </tbody>
</table>
        ...
        function getNotifications(){
            ...
            $.get('/get-notifications', function (data){
                ...
                data.forEach(function(item){
                    ...
                    countColumns ++;
                    $('#notification_nav_table').append('<tr id="notification-'+countColumns+'" class="d-flex notification-content"></tr>');
                ...
                if(countALL == 0){
                    $('#notification_nav_table').append('<tr id="notification-empty" class="d-flex notification-content"></tr>');
                    $('#notification-empty')
