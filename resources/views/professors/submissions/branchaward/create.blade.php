<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 font-weight-bold">
            {{ __('VI.  Awards/Recognitions Received by College/Branch/Campus from  Reputable Organizations > Create') }}
        </h2>
    </x-slot>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('professor.submissions.branchaward.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('certifyingbody')" class="{{ $errors->has('certifyingbody') ? 'is-invalid' : '' }}" type="text" name="certifyingbody" autofocus autocomplete="certifyingbody" />
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('place')" class="{{ $errors->has('place') ? 'is-invalid' : '' }}" type="text" name="place" autofocus autocomplete="place" />
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('date')" class="{{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" id="date-start" name="date" autofocus autocomplete="date" />
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="level" id="level" class="form-control custom-select {{ $errors->has('level') ? 'is-invalid' : '' }}" autofocus autocomplete="level">
                                            ...
                                            <option value="1" {{ ((old('level') == "1") ? 'selected' : '' )}}>International</option>    
                                            <option value="2" {{ ((old('level') == "2") ? 'selected' : '' )}}>National</option>    
                                            <option value="3" {{ ((old('level') == "3") ? 'selected' : '' )}}>Local</option>    
                                        </select>
