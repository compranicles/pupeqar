                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <br>
                                <a href="{{ route('professor.branchaward.resubmit', $branchaward->id) }}" class=" mt-3 btn btn-success h5">Re-Submit</a>
                            </div>
                        </div>
                        @endif
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Name of Award: </span>
                                                <span class="d-block ml-4">{{ $branchaward->name }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Certifying Body: </span>
                                                <span class="d-block ml-4">{{ $branchaward->certifying_body }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Place: </span>
                                                <span class="d-block ml-4">{{ $branchaward->place }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Date: </span>
                                                <span class="d-block ml-4">{{ date("F j, Y" , strtotime( $branchaward->date)) }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Level: </span>
                                                @if($branchaward->level == 1)
                                                    <span class="d-block ml-4">International</span>
                                                @elseif($branchaward->level == 2)
                                                    <span class="d-block ml-4">National</span>
                                                @else
                                                    <span class="d-block ml-4">Local</span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <span class="d-block ml-4">{{ $branchaward->document_description }}</span>
                            </div>
                        </div>
                    </div>
                </div>
