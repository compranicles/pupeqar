<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 font-weight-bold">
            {{ __('E.1. Expert Service Rendered - in Conferences > Edit') }}
        </h2>
    </x-slot>
    <div class="container">
        <div class="row mb-3">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route('professor.submissions.expertconference.show', $expertconference->id) }}" class="btn btn-secondary mb-2 mr-2"><i class="fas fa-arrow-left mr-2"></i> Back</a>
                            </div>
                        </div>
                        <hr>
                        <form action="{{ route('professor.submissions.expertconference.update', $expertconference->id) }}" method="POST">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="department" id="department" class="form-control custom-select {{ $errors->has('department') ? 'is-invalid' : '' }}" autofocus autocomplete="department">
                                            ...
                                            <option value="{{ $department->id }}" {{ ((old('department', $expertconference->department_id) == $department->id) ? 'selected' : '' )}}>{{ $department->name }}</option>    
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="serviceconference" id="serviceconference" class="form-control custom-select {{ $errors->has('serviceconference') ? 'is-invalid' : '' }}" autofocus autocomplete="serviceconference">
                                            ...
                                            <option value="{{ $serviceconference->id }}" {{ ((old('serviceconference', $expertconference->service_conference_id) == $serviceconference->id) ? 'selected' : '' )}}>{{ $serviceconference->name }}</option>    
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('conferencetitle', $expertconference->conference_title)" class="{{ $errors->has('conferencetitle') ? 'is-invalid' : '' }}" type="text" name="conferencetitle" autofocus autocomplete="conferencetitle" />
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('partneragency', $expertconference->partner_agency)" class="{{ $errors->has('partneragency') ? 'is-invalid' : '' }}" type="text" name="partneragency" autofocus autocomplete="partneragency" />
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('venue', $expertconference->venue)" class="{{ $errors->has('venue') ? 'is-invalid' : '' }}" type="text" name="venue" autofocus autocomplete="venue" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('datestarted', $expertconference->date_started)" class="{{ $errors->has('datestarted') ? 'is-invalid' : '' }}" type="text" id="datestarted" name="datestarted" autofocus autocomplete="datestarted" />
                                ...
                                <div class="col-lg-4 ">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input value="{{ old('dateended', $expertconference->date_ended) == '' ? date('Y-m-d') : old('dateended', $expertconference->date_ended) }}" class="{{ $errors->has('dateended') ? 'is-invalid' : '' }}" type="text" id="dateended" name="dateended" autofocus autocomplete="dateended" />
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="{{ $errors->has('present') ? 'is-invalid' : '' }}" type="checkbox" id="present" name="present" autofocus {{  $expertconference->present == 'on' ? 'checked' : '' }} autocomplete="present" >
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="level" id="level" class="form-control custom-select {{ $errors->has('level') ? 'is-invalid' : '' }}" autofocus autocomplete="level">
                                            ...
                                            <option value="{{ $level->id }}" {{ ((old('level', $expertconference->level_id) == $level->id) ? 'selected' : '' )}}>{{ $level->name }}</option>    
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('documentdescription') ? 'is-invalid' : '' }}" name="documentdescription" cols="30" rows="5" autofocus autocomplete="documentdescription">{{ old('documentdescription', $expertconference->document_description) }}</textarea>
                            ...
                            <div class="mb-0">
                                <div class="d-flex justify-content-end align-items-baseline">
                                    <a href="{{ route('professor.submissions.expertconference.show', $expertconference->id) }}" class="btn btn-outline-danger mr-2">
                                        CANCEL
                                    </a>
                                    <x-jet-button>
                                        {{ __('Submit') }}
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="card bg-light border border-maroon rounded-lg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <form action="{{   route('professor.expertconference.file.delete', $document->submission_id)  }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                                                        @csrf
