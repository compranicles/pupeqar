                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12 d-flex">
                                <div>
                                    ...
                                    @if ($submission->status == 1)
                                        <a href="{{ route('professor.submissions.expertconference.edit', $expertconference->id) }}"  class="btn btn-primary mb-2 mr-2"><i class="far fa-edit"></i> Edit</a>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <br>
                                <a href="{{ route('professor.expertconference.resubmit', $expertconference->id) }}" class=" mt-3 btn btn-success h5">Re-Submit</a>
                            </div>
                        </div>
                        @endif
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Nature of Services Rendered in Conferences, Workshops, and/or Training Courses for Professionals: </span>
                                                <span class="d-block ml-4">{{ $serviceconference->name }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Title of Conference, Workshop, and Training: </span>
                                                <span class="d-block ml-4">{{ $expertconference->conference_title}}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Partner Agency: </span>
                                                <span class="d-block ml-4">{{ $expertconference->partner_agency }}</span>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12 mb-1">
                                                ...
                                                <span class="d-block ml-4">{{ $expertconference->venue }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">From: </span>
                                                <span class="d-block ml-4">{{ date("F j, Y" , strtotime( $expertconference->date_started)) }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">To: </span>
                                                <span class="d-block ml-4">
                                                    @if ($expertconference->present == 'on')
                                                        Present
                                                    @else
                                                        {{ date("F j, Y" , strtotime( $expertconference->date_ended)) }}
                                                    @endif
                                                </span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <span class="d-block ml-4">{{ $expertconference->document_description }}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('professor.submissions.expertconference.destroy', $expertconference->id) }}" method="POST">
