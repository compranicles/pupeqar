<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 font-weight-bold">
            {{ __('E.1. Expert Service Rendered - in Academic Journals > Create') }}
        </h2>
    </x-slot>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('professor.submissions.expertjournal.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <select name="servicejournal" id="servicejournal" class="form-control custom-select {{ $errors->has('servicejournal') ? 'is-invalid' : '' }}" autofocus autocomplete="servicejournal">
                                            ...
                                            <option value="{{ $servicejournal->id }}" {{ ((old('servicejournal') == $servicejournal->id) ? 'selected' : '' )}}>{{ $servicejournal->name }}</option>    
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="servicenature" id="servicenature" class="form-control custom-select {{ $errors->has('servicenature') ? 'is-invalid' : '' }}" autofocus autocomplete="servicenature">
                                            ...
                                            <option value="{{ $servicenature->id }}" {{ ((old('servicenature') == $servicenature->id) ? 'selected' : '' )}}>{{ $servicenature->name }}</option>    
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('production')" class="{{ $errors->has('production') ? 'is-invalid' : '' }}" type="text" name="production" autofocus autocomplete="production" />
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="indexplatform" id="indexplatform" class="form-control custom-select {{ $errors->has('indexplatform') ? 'is-invalid' : '' }}" autofocus autocomplete="indexplatform">
                                            ...
                                            <option value="{{ $indexplatform->id }}" {{ ((old('indexplatform') == $indexplatform->id) ? 'selected' : '' )}}>{{ $indexplatform->name }}</option>    
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('isbn')" class="{{ $errors->has('isbn') ? 'is-invalid' : '' }}" type="text" name="isbn" autofocus autocomplete="isbn" />
