<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 font-weight-bold">
            {{ __('E.4. Faculty Involvement in Inter-Country Mobility > Edit') }}
        </h2>
    </x-slot>
    <div class="container">
        <div class="row mb-3">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route('professor.submissions.facultyintercountry.show', $facultyintercountry->id) }}" class="btn btn-secondary mb-2 mr-2"><i class="fas fa-arrow-left mr-2"></i> Back</a>
                            </div>
                        </div>
                        <hr>
                        <form action="{{ route('professor.submissions.facultyintercountry.update', $facultyintercountry->id) }}" method="POST">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="department" id="department" class="form-control custom-select {{ $errors->has('department') ? 'is-invalid' : '' }}" autofocus autocomplete="department">
                                            ...
                                            <option value="{{ $department->id }}" {{ ((old('department', $facultyintercountry->department_id) == $department->id) ? 'selected' : '' )}}>{{ $department->name }}</option>    
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="engagementnature" id="engagementnature" class="form-control custom-select {{ $errors->has('engagementnature') ? 'is-invalid' : '' }}" autofocus autocomplete="engagementnature">
                                            ...
                                            <option value="{{ $engagementnature->id }}" {{ ((old('engagementnature', $facultyintercountry->engagement_nature_id) == $engagementnature->id) ? 'selected' : '' )}}>{{ $engagementnature->name }}</option>    
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="facultyinvolvement" id="facultyinvolvement" class="form-control custom-select {{ $errors->has('facultyinvolvement') ? 'is-invalid' : '' }}" autofocus autocomplete="facultyinvolvement">
                                            ...
                                            <option value="{{ $facultyinvolvement->id }}" {{ ((old('facultyinvolvement', $facultyintercountry->faculty_involvement_id) == $facultyinvolvement->id) ? 'selected' : '' )}}>{{ $facultyinvolvement->name }}</option>    
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('hostname', $facultyintercountry->host_name)" class="{{ $errors->has('hostname') ? 'is-invalid' : '' }}" type="text" name="hostname" autofocus autocomplete="hostname" />
                            ...
                            <div class="row">
                                <div class="col-lg-10">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('hostaddress', $facultyintercountry->host_address)" class="{{ $errors->has('hostaddress') ? 'is-invalid' : '' }}" type="text" name="hostaddress" autofocus autocomplete="hostaddress" />
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('hosttype', $facultyintercountry->host_type)" class="{{ $errors->has('hosttype') ? 'is-invalid' : '' }}" type="text" name="hosttype" autofocus autocomplete="hosttype" />
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('datestarted', $facultyintercountry->date_started)" class="{{ $errors->has('datestarted') ? 'is-invalid' : '' }}" type="text" id="date-start" name="datestarted" autofocus autocomplete="datestarted" />
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('dateended', $facultyintercountry->date_ended)" class="{{ $errors->has('dateended') ? 'is-invalid' : '' }}" type="text" id="date-end" name="dateended" autofocus autocomplete="dateended" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('documentdescription') ? 'is-invalid' : '' }}" name="documentdescription" cols="30" rows="5" autofocus autocomplete="documentdescription">{{ old('documentdescription', $facultyintercountry->document_description) }}</textarea>
                            ...
                            <div class="mb-0">
                                <div class="d-flex justify-content-end align-items-baseline">
                                    <a href="{{ route('professor.submissions.facultyintercountry.show', $facultyintercountry->id) }}" class="btn btn-outline-danger mr-2">
                                        CANCEL
                                    </a>
                                    <x-jet-button>
                                        {{ __('Submit') }}
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="card bg-light border border-maroon rounded-lg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <form action="{{   route('professor.facultyintercountry.file.delete', $document->submission_id)  }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                                                        @csrf
