                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12 d-flex">
                                <div>
                                    ...
                                    @if ($submission->status == 1)
                                        <a href="{{ route('professor.submissions.facultyintercountry.edit', $facultyintercountry->id) }}"  class="btn btn-primary mb-2 mr-2"><i class="far fa-edit"></i> Edit</a>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <br>
                                <a href="{{ route('professor.facultyintercountry.resubmit', $facultyintercountry->id) }}" class=" mt-3 btn btn-success h5">Re-Submit</a>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h3 id="textHome" class="font-weight-bold text-center" style="color:maroon">Faculty Involvement in Inter-Country Mobility</h3>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Nature of Engagement: </span>
                                                <span class="d-block ml-4">{{ $engagementnature->name }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Type: </span>
                                                <span class="d-block ml-4">{{ $facultyinvolvement->name }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Host Institution/Organization/Agency: </span>
                                                <span class="d-block ml-4">{{ $facultyintercountry->host_name }}</span>
                                            </div>
                                            <div class="col-md-12">
                                                <span class="d-block font-weight-bold">Address of Host Institution/Organization/Agency/Country: </span>
                                                <span class="d-block ml-4">{{ $facultyintercountry->host_address }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Type: </span>
                                                <span class="d-block ml-4">{{ $facultyintercountry->host_type }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">From: </span>
                                                <span class="d-block ml-4">{{ date("F j, Y" , strtotime( $facultyintercountry->date_started)) }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">To: </span>
                                                <span class="d-block ml-4">
                                                     {{ date("F j, Y" , strtotime( $facultyintercountry->date_ended)) }}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <span class="d-block ml-4">{{ $facultyintercountry->document_description }}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('professor.submissions.facultyintercountry.destroy', $facultyintercountry->id) }}" method="POST">
