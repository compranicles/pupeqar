                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12 d-flex">
                                <div>
                                    ...
                                    @if ($submission->status == 1)
                                        <a href="{{ route('professor.submissions.invention.edit', $invention->id) }}"  class="btn btn-primary mb-2 mr-2"><i class="far fa-edit"></i> Edit</a>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <br>
                                <a href="{{ route('professor.invention.resubmit', $invention->id) }}" class=" mt-3 btn btn-success h5">Re-Submit</a>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h3 id="textHome" class="font-weight-bold text-center" style="color:maroon">Faculty Invention, Innovation and Creative Works Commitment</h3>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Title of the Invention, Innovation & Creative Works: </span>
                                                <span class="d-block ml-4">{{ $invention->invention_title }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Classification: </span>
                                                <span class="d-block ml-4">{{ $inventionclass->name }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Collaborator/s: </span>
                                                <span class="d-block ml-4">{{ $invention->collaborator }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">From: </span>
                                                <span class="d-block ml-4">{{ date("F j, Y" , strtotime( $invention->date_started)) }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">To: </span>
                                                <span class="d-block ml-4">
                                                    @if ($invention->present == 'on')
                                                        Present
                                                    @else
                                                        {{ date("F j, Y" , strtotime( $invention->date_ended)) }}
                                                    @endif
                                                </span>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Nature of Inventions (IT Products, Equipments, Machinery, etc.): </span>
                                                <span class="d-block ml-4">{{ $invention->invention_nature }}</span>
                                            </div>
                                            <div class="col-md-12">
                                                <span class="d-block font-weight-bold">Status: </span>
                                                <span class="d-block ml-4">{{ $inventionstatus->name }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Funding Agency: </span>
                                                <span class="d-block ml-4">{{ $invention->funding_agency }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                            ...
                                            <div class="col-md-12 mb-1">
                                                ...
                                                <span class="d-block ml-4">{{ $invention->funding_amount }}</span>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <span class="d-block ml-4">{{ $invention->document_description }}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('professor.submissions.invention.destroy', $invention->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
