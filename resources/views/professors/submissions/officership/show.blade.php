                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12 d-flex">
                                <div>
                                    ...
                                    @if ($submission->status == 1)
                                        <a href="{{ route('professor.submissions.officership.edit', $officership->id) }}"  class="btn btn-primary mb-2 mr-2"><i class="far fa-edit"></i> Edit</a>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <br>
                                <a href="{{ route('professor.officership.resubmit', $officership->id) }}" class=" mt-3 btn btn-success h5">Re-Submit</a>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h3 id="textHome" class="font-weight-bold text-center" style="color:maroon">Officership/Membership in Professional Organization/s</h3>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Name of Organization: </span>
                                                <span class="d-block ml-4">{{ $officership->organization }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Classification: </span>
                                                <span class="d-block ml-4">{{ $facultyofficer->name }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Position: </span>
                                                <span class="d-block ml-4">{{ $officership->position }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Organization Address: </span>
                                                <span class="d-block ml-4">{{ $officership->organization_address }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">From: </span>
                                                <span class="d-block ml-4">{{ date("F j, Y" , strtotime( $officership->date_started)) }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">To: </span>
                                                <span class="d-block ml-4">
                                                    @if ($officership->present == 'on')
                                                        Present
                                                    @else
                                                        {{ date("F j, Y" , strtotime( $officership->date_ended)) }}
                                                    @endif
                                                </span>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <span class="d-block ml-4">{{ $officership->documentdescription }}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('professor.submissions.officership.destroy', $officership->id) }}" method="POST">
