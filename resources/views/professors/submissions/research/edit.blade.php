<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 font-weight-bold">
            {{ __('C.1. Research Ongoing/Completed > Edit') }}
        </h2>
    </x-slot>
    <div class="container">
        <div class="row mb-3">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route('professor.submissions.research.show', $research->id) }}" class="btn btn-secondary mb-2 mr-2"><i class="fas fa-arrow-left mr-2"></i> Back</a>
                            </div>
                        </div>
                        <hr>
                        <form action="{{ route('professor.submissions.research.update', $research->id) }}" method="POST">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="department" id="department" class="form-control custom-select {{ $errors->has('department') ? 'is-invalid' : '' }}" autofocus autocomplete="department">
                                            ...
                                            <option value="{{ $department->id }}" {{ ((old('department', $research->department_id) == $department->id) ? 'selected' : '' )}}>{{ $department->name }}</option>    
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="researchclass" id="researchclass" class="form-control custom-select {{ $errors->has('researchclass') ? 'is-invalid' : '' }}" autofocus autocomplete="researchclass">
                                            ...
                                            <option value="{{ $researchclass->id }}" {{ ((old('researchclass', $research->research_class_id) == $researchclass->id) ? 'selected' : '' )}}>{{ $researchclass->name }}</option>    
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="researchcategory" id="researchcategory" class="form-control custom-select {{ $errors->has('researchcategory') ? 'is-invalid' : '' }}" autofocus autocomplete="researchcategory">
                                            ...
                                            <option value="{{ $researchcategory->id }}" {{ ((old('researchcategory', $research->research_category_id) == $researchcategory->id) ? 'selected' : '' )}}>{{ $researchcategory->name }}</option>    
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select name="researchagenda" id="researchagenda" class="form-control custom-select {{ $errors->has('researchagenda') ? 'is-invalid' : '' }}" autofocus autocomplete="researchagenda">
                                            ...
                                            <option value="{{ $researchagenda->id }}" {{ ((old('researchagenda', $research->research_agenda_id) == $researchagenda->id) ? 'selected' : '' )}}>{{ $researchagenda->name }}</option>    
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" name="title" cols="30" rows="5" autofocus autocomplete="title">{{ old('title', $research->title) }}</textarea>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('researchers') ? 'is-invalid' : '' }}" name="researchers" cols="30" rows="5" autofocus autocomplete="researchers">{{ old('researchers', $research->researchers) }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select name="researchinvolve" id="researchinvolve" class="form-control custom-select {{ $errors->has('researchinvolve') ? 'is-invalid' : '' }}" autofocus autocomplete="researchinvolve">
                                            ...
                                            <option value="{{ $researchinvolve->id }}" {{ ((old('researchinvolve', $research->research_involve_id) == $researchinvolve->id) ? 'selected' : '' )}}>{{ $researchinvolve->name }}</option>    
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="researchtype" id="researchtype" class="form-control custom-select {{ $errors->has('researchtype') ? 'is-invalid' : '' }}" autofocus autocomplete="researchtype">
                                            ...
                                            <option value="{{ $researchtype->id }}" {{ ((old('researchtype', $research->research_type_id) == $researchtype->id) ? 'selected' : '' )}}>{{ $researchtype->name }}</option>    
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('keywords') ? 'is-invalid' : '' }}" name="keywords" cols="30" rows="5" autofocus autocomplete="title">{{ old('keywords', $research->keywords) }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select name="fundingtype" id="fundingtype" class="form-control custom-select {{ $errors->has('fundingtype') ? 'is-invalid' : '' }}" autofocus autocomplete="fundingtype">
                                            ...
                                            <option value="{{ $fundingtype->id }}" {{ ((old('fundingtype', $research->funding_type_id) == $fundingtype->id) ? 'selected' : '' )}}>{{ $fundingtype->name }}</option>    
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('fundingamount', $research->funding_amount)" class="{{ $errors->has('fundingamount') ? 'is-invalid' : '' }}" type="text" id="fundingamount" name="fundingamount" autofocus autocomplete="fundingamount" />
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('fundingagency', $research->funding_agency)" class="{{ $errors->has('fundingagency') ? 'is-invalid' : '' }}" type="text" id="fundingagency" name="fundingagency" autofocus autocomplete="fundingagency" />
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('datestarted', $research->date_started)" class="{{ $errors->has('datestarted') ? 'is-invalid' : '' }}" type="text" id="datestarted " name="datestarted" autofocus autocomplete="datestarted " />
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('datetargeted', $research->date_targeted)" class="{{ $errors->has('datetargeted') ? 'is-invalid' : '' }}" type="text" id="datetargeted" name="datetargeted" autofocus autocomplete="datetargeted" />
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control custom-select {{ $errors->has('status') ? 'is-invalid' : '' }}" autofocus autocomplete="status">
                                            <option value="" selected disabled>Choose...</option>
                                            <option value="1" {{ ((old('status', $research->status) == "1") ? 'selected' : '' )}}>Ongoing</option>    
                                            <option value="2" {{ ((old('status', $research->status) == "2") ? 'selected' : '' )}}>Completed</option>    
                                        </select>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('datecompleted', $research->date_completed)" class="{{ $errors->has('datecompleted') ? 'is-invalid' : '' }}" type="text" id="datecompleted" name="datecompleted" autofocus autocomplete="datecompleted" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('documentdescription') ? 'is-invalid' : '' }}" name="documentdescription" cols="30" rows="5" autofocus autocomplete="documentdescription">{{ old('documentdescription', $research->document_description) }}</textarea>
                            ...
                            <div class="mb-0">
                                <div class="d-flex justify-content-end align-items-baseline">
                                    <a href="{{ route('professor.submissions.research.show', $research->id) }}" class="btn btn-outline-danger mr-2">
                                        CANCEL
                                    </a>
                                    <x-jet-button>
                                        {{ __('Submit') }}
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="card bg-light border border-maroon rounded-lg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <form action="{{   route('professor.research.file.delete', $document->submission_id)  }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                                                        @csrf
