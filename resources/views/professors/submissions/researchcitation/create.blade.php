<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 font-weight-bold">
            {{ __('C.4. Research Citation > Create') }}
        </h2>
    </x-slot>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('professor.submissions.researchcitation.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('researchcited') ? 'is-invalid' : '' }}" name="researchcited" cols="30" rows="5" autofocus autocomplete="researchcited">{{ old('researchcited') }}</textarea>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('articletitle') ? 'is-invalid' : '' }}" name="articletitle" cols="30" rows="5" autofocus autocomplete="articletitle">{{ old('articletitle') }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('authorcited') ? 'is-invalid' : '' }}" name="authorcited" cols="30" rows="5" autofocus autocomplete="authorcited">{{ old('authorcited') }}</textarea>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('journaltitle') ? 'is-invalid' : '' }}" name="journaltitle" cols="30" rows="5" autofocus autocomplete="journaltitle">{{ old('journaltitle') }}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('year')" class="{{ $errors->has('year') ? 'is-invalid' : '' }}" type="text" id="year" name="year" autofocus autocomplete="year" />
