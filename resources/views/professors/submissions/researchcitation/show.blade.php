            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form action="{{ route('professor.submissions.researchcitation.destroy', $research->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                    ...
                                    <a href="{{ route('professor.submissions.researchcitation.edit', $research->id) }}"  class="btn btn-primary mb-2 mr-2"><i class="far fa-edit"></i> Edit</a>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h3 id="textHome" class="font-weight-bold text-center" style="color:maroon">Research Citation</h3>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Title of Research/Article Cited: </span>
                                                <span class="d-block ml-4">{{ $research->research_cited }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Title of Article Where Your Research has been Cited: </span>
                                                <span class="d-block ml-4">{{ $research->article_title }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Author/s Who Cited Your Research: </span>
                                                <span class="d-block ml-4">{{ $research->author_cited }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Title of the Journal/Books Where Your Article has been Cited: </span>
                                                <span class="d-block ml-4">{{ $research->journal_title }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Volume No. of the Journal/Book Where Your Article has been Cited: </span>
                                                <span class="d-block ml-4">{{ $research->volume }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Issue No. of the Journal/Book Where Your Article has been Cited: </span>
                                                <span class="d-block ml-4">{{ $research->issue }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Page No. of the Journal Where Your Article has been Cited: </span>
                                                <span class="d-block ml-4">{{ $research->page }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Year of Publication of the Journal Where Your Article has been Cited: </span>
                                                <span class="d-block ml-4">{{ $research->year }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Name of Publisher of the Journal Where Your Article has been Cited: </span>
                                                <span class="d-block ml-4">{{ $research->publisher }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Indexing Platform of the Journal Where Your Article has been Cited: </span>
                                                <span class="d-block ml-4">{{ $indexplatform->name}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
