<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 font-weight-bold">
            {{ __('C.6. Copyrighted Research Output > Create') }}
        </h2>
    </x-slot>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('professor.submissions.researchcopyright.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('copyrightagency')" class="{{ $errors->has('copyrightagency') ? 'is-invalid' : '' }}" type="text" id="copyrightagency" name="copyrightagency" autofocus autocomplete="copyrightagency" />
