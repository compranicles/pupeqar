<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 font-weight-bold">
            {{ __('C.3. Research Presentation > Create') }}
        </h2>
    </x-slot>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('professor.submissions.researchpresentation.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('conferencetitle')" class="{{ $errors->has('conferencetitle') ? 'is-invalid' : '' }}" type="text" id="conferencetitle" name="conferencetitle" autofocus autocomplete="conferencetitle" />
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('organizer')" class="{{ $errors->has('organizer') ? 'is-invalid' : '' }}" type="text" id="organizer" name="organizer" autofocus autocomplete="organizer" />
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('venue')" class="{{ $errors->has('venue') ? 'is-invalid' : '' }}" type="text" id="venue" name="venue" autofocus autocomplete="venue" />
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('datepresented')" class="{{ $errors->has('datepresented') ? 'is-invalid' : '' }}" type="text" id="datepresented" name="datepresented" autofocus autocomplete="datepresented" />
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select name="researchlevel" id="researchlevel" class="form-control custom-select {{ $errors->has('researchlevel') ? 'is-invalid' : '' }}" autofocus autocomplete="researchlevel">
                                            ...
                                            <option value="{{ $researchlevel->id }}" {{ ((old('researchlevel') == $researchlevel->id) ? 'selected' : '' )}}>{{ $researchlevel->name }}</option>    
                                            @endforeach
                                        </select>
