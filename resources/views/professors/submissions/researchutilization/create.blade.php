<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 font-weight-bold">
            {{ __('C.5. Research Utilization > Create') }}
        </h2>
    </x-slot>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('professor.submissions.researchutilization.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('organization')" class="{{ $errors->has('organization') ? 'is-invalid' : '' }}" type="text" id="organization" name="organization" autofocus autocomplete="organization" />
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('briefdescription') ? 'is-invalid' : '' }}" name="briefdescription" cols="30" rows="5" autofocus autocomplete="briefdescription" >{{ old('briefdescription') }}</textarea>
