                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12 d-flex">
                                <div>
                                    ...
                                    @if ($submission->status == 1)
                                        <a href="{{ route('professor.submissions.'.$route.'.edit', $specialtask->id) }}"  class="btn btn-primary mb-2 mr-2"><i class="far fa-edit"></i> Edit</a>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <br>
                                <a href="{{ route('professor.'.$route.'.resubmit', $specialtask->id) }}" class=" mt-3 btn btn-success h5">Re-Submit</a>
                            </div>
                        </div>
                        @endif
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Final Output: </span>
                                                <span class="d-block ml-4">{{ $specialtask->output }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Classification: </span>
                                                <span class="d-block ml-4"><b>Target: </b> {{ $specialtask->target }}</span>
                                                <span class="d-block ml-4"><b>Actual: </b> {{ $specialtask->actual }}</span>
                                                <span class="d-block ml-4"><b>Accomplishment: </b> {{ $specialtask->accomplishment }}</span>
                                            </div>
                                            <div class="col-md-12 mb-1">
                                                <span class="d-block font-weight-bold">Proof of Compliance: </span>
                                                <span class="d-block ml-4"><b>Status: </b> {{ $specialtask->status }}</span>
                                                <span class="d-block ml-4"><b>Remarks: </b> {{ $specialtask->remarks }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <span class="d-block ml-4">{{ $specialtask->document_description }}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('professor.submissions.'.$route.'.destroy', $specialtask->id) }}" method="POST">
