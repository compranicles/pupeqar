<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 font-weight-bold">
            {{ __('F.2. Course Syllabus/Guide Developed/Revised/Enhanced > Edit') }}
        </h2>
    </x-slot>
    <div class="container">
        <div class="row mb-3">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route('professor.submissions.syllabus.show', $syllabus->id) }}" class="btn btn-secondary mb-2 mr-2"><i class="fas fa-arrow-left mr-2"></i> Back</a>
                            </div>
                        </div>
                        <hr>
                        <form action="{{ route('professor.submissions.syllabus.update', $syllabus->id) }}" method="POST">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="department" id="department" class="form-control custom-select {{ $errors->has('department') ? 'is-invalid' : '' }}" autofocus autocomplete="department">
                                            ...
                                            <option value="{{ $department->id }}" {{ ((old('department', $syllabus->department_id) == $department->id) ? 'selected' : '' )}}>{{ $department->name }}</option>    
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('title', $syllabus->title)" class="{{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" autofocus autocomplete="title" />
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('date', $syllabus->date)" class="{{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" id="date" name="date" autofocus autocomplete="date" />
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input :value="old('assigntask', $syllabus->assign_task)" class="{{ $errors->has('assigntask') ? 'is-invalid' : '' }}" type="text" name="assigntask" autofocus autocomplete="assigntask" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('documentdescription') ? 'is-invalid' : '' }}" name="documentdescription" cols="30" rows="5" autofocus autocomplete="documentdescription">{{ old('documentdescription', $syllabus->document_description) }}</textarea>
                            ...
                            <div class="mb-0">
                                <div class="d-flex justify-content-end align-items-baseline">
                                    <a href="{{ route('professor.submissions.syllabus.show', $syllabus->id) }}" class="btn btn-outline-danger mr-2">
                                        CANCEL
                                    </a>
                                    <x-jet-button>
                                        {{ __('Submit') }}
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="card bg-light border border-maroon rounded-lg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <form action="{{   route('professor.syllabus.file.delete', $document->submission_id)  }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                                                        @csrf
