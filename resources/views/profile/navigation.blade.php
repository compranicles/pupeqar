...
<a href="{{ route('profile.workExperience') }}" class="submission-menu {{ request()->routeIs('profile.workExperience') || request()->routeIs('profile.workExperience.view') ? 'active' : '' }}">Work Experience</a>
