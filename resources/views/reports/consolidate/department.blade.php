<x-app-layout>   
    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="row justify-content-between">
                <div class="col-md-12">
                    <h5 class="d-inline-block" style="padding-top: 10px;">{{ $department->name }} - Consolidated Accomplishments</h5>
                    ...
                    <div class="float-right">
                        <button type="button" class="btn btn-primary ml-2" data-target="#GenerateLevelReport" data-toggle="modal"><i class="bi bi-file-earmark-text"></i> Generate Department Level Report</button>
                    </div>
                </div>
            </div>
            <hr>
    ...
    @include('reports.generate.level', ['data' => $user, 'source_type' => 'my', 'type_generate' => 'department_level'])
