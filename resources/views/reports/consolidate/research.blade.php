<x-app-layout>   
    ...
    <div class="row">
        <div class="col-md-12">
            <h2 class="font-weight-bold mb-2">Consolidated QAR - {{ $department->code }} Research & Invention</h2>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
    ...
    @push('scripts')
        ...
        <script>
            $('#quarterYearFilter').on('click', function () {
                ...
                var link = "/reports/consolidate/research/reportYearFilter/:department/:year/:quarter";
