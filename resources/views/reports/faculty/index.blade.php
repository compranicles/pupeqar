                                                        ...
                                                        <table class="table table-sm table-bordered table-hover">
                                                            ...
                                                            <tbody>
                                                                @foreach ($report_array[$table->id] as $row)
                                                                    <tr class="report-view" role="button" data-toggle="modal" data-target="#viewReport" data-id="{{ $table->id }}" data-code="@isset($row->id){{ $row->id }}@else{{ $row->research_code }}@endisset">
