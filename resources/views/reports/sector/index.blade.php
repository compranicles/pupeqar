                                                    ...
                                                    <tbody>
                                                        @foreach ($reportsToReview as $row)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button class="btn btn-primary btn-sm button-view" id="viewButton" data-url="{{ route('document.download', ':filename') }}" data-accept="{{ route('sector.accept', ':id') }}" data-id="{{ $row->id }}" data-toggle="modal" data-target="#viewReport">View</button>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
