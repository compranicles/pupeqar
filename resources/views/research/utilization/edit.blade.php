<x-app-layout>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                @include('research.navigation-bar', ['research_code' => $research->research_code ?? $research['research_code'], 'research_status' => $research->status ?? $research['status']])
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('research.utilization.update', [$research['research_code'], $values['id']]) }}" method="post">
                            @csrf
                            @method('put')
