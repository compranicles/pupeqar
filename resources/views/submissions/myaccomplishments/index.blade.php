                                        ...
                                        <tr role="button">
                                            ...
                                            <td>
                                                @if (
                                                    ...
                                                    <button type="button" class="button-deny action-remarks mb-1" data-toggle="modal" data-target="#viewDeny" data-id="{{ $row->id }}"><i class="bi bi-chat-square-text"></i> Remarks</button>
                                                    <br>
